...
function FromClient_LoginNickname_All_SetRecommandNickName(recommandNickName)
  if nil == Panel_Login_Nickname_All then
    return
  end
  PaGlobal_LoginNickname_All:setRecommandNickName(recommandNickName)
  lobbyNickname_createNickname(recommandNickName)
end
