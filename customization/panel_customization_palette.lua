...
function CreateCommonPalette(FrameTemplate, ftCollision, classType, paramType, paramIndex, PaletteIndex, isBlend)
  ...
  if true == _ContentsGroup_RgbUIPick and (__eRgbLimitationOnHairBase == paramIndex or __eRgbLimitationOnHairEnd == paramIndex or __eRgbLimitationOnHairIn == paramIndex) then
    isPaletteOpen = true
  end
  if false == isPaletteOpen then
    ...
    if nil ~= Frame_Button then
      ...
      if nil ~= PaGlobal_ColorPalette_All_Open then
        colorSelectionButton:addInputEvent("Mouse_LUp", "PaGlobal_ColorPalette_All_Open(" .. classType .. "," .. paramType .. "," .. paramIndex .. ")")
      end
