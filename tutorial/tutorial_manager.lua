...
function PaGlobal_TutorialManager:initializeClassBasicSkillPhaseTable()
  ...
  self._classBasicSkillPhaseList[__eClassType_ReservedBlackSpirit] = PaGlobal_TutorialPhase_BasicSkill_Wizard
  self._classBasicSkillPhaseList[__eClassType_Sorcerer_Reserved1] = PaGlobal_TutorialPhase_BasicSkill_Wizard
end
