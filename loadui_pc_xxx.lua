...
function preLoadGameUI_PC()
  ...
  basicLoadUI("UI_Data/Widget/Tooltip/Panel_Window_Stat_All.xml", "Panel_Window_Stat_All", UIGroup.PAGameUIGroup_Windows)
  ...
  loadUI("UI_Data/Window/TradeMarket/Panel_Window_OTPConfirm_All.XML", "Panel_Window_OTPConfirm_All", UIGroup.PAGameUIGroup_GameMenu, PAUIRenderModeBitSet({
    RenderMode.eRenderMode_Dialog
  }))
  ...
  if true == _ContentsGroup_HopeGauge then
    ...
    basicLoadUI("UI_Data/Widget/MainStatus/Panel_Widget_HopeGaugeOnOff.XML", "Panel_Widget_HopeGaugeOnOff", UIGroup.PAGameUIGroup_Interaction)
  end
  ...
  basicLoadUI("UI_Data/Widget/NpcNavigation/Panel_Widget_TownSimpleNavi.XML", "Panel_Widget_TownSimpleNavi_All", UIGroup.PAGameUIGroup_Windows)
...
function loadGameUI_PC_XXX()
  ...
  runLua("UI_Data/Script/GlobalKeyBinder/globalKeyBinderManager_XXX.lua")
  runLua("UI_Data/Script/GlobalKeyBinder/globalKeyBinder_XXX.lua")
  if true == _ContentsGroup_MansionContent then
...
PaGlobal_SetLoadUIFunc(loadGameUI_PC_XXX, LOADUI_TYPE.GameUI_XXX)
