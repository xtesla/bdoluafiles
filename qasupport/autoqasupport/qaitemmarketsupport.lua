...
function itemMarketSupport:init()
  ...
  registerEvent("FromClient_responseDetailListByWorldMarketByMainKey", "PaGlobalFunc_responseWorldMarketItemMarketTest")
...
function itemMarketSupport:getHistoryName(historyType)
  ...
  elseif historyType == __eWorldMarket_HistoryType_SellWait then
    return "\237\134\181\237\149\169 \234\177\176\235\158\152\236\134\140 \237\140\144\235\167\164 \235\147\177\235\161\157 \236\164\145"
  elseif historyType == __eWorldMarket_HistoryType_SellWaitFail then
    return "\237\134\181\237\149\169 \234\177\176\235\158\152\236\134\140 \237\140\144\235\167\164 \235\140\128\234\184\176 \236\152\136\236\149\189 \236\139\164\237\140\168"
...
function PaGlobalFunc_responseWorldMarketItemMarketTest()
  ...
  ToClient_requestGetBiddingList(__eWorldMarketKeyType_Item, itemMarketSupport.selectItemKey, selectLevel, true, PaGlobalFunc_ItemMarket_GetCurrentCategory())
end
