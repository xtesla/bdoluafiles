...
function PaGlobal_Equipment_All:setData()
  ...
  if true == _ContentsGroup_TransferEventBuff then
    self._ui.stc_blackSpiritBackImage:SetShow(true)
    self._ui.stc_imageWalk:SetShow(true)
    self._ui.stc_imageGo:SetShow(false)
  else
    self._ui.stc_blackSpiritBackImage:SetShow(false)
    self._ui.stc_imageWalk:SetShow(false)
    self._ui.stc_imageGo:SetShow(false)
  end
...
function PaGlobal_Equipment_All:registerEventHandler()
  ...
  if true == _ContentsGroup_TransferEventBuff then
    self._ui.stc_imageWalk:addInputEvent("Mouse_On", "HandleEventOnOut_Equipment_All_ChangeBlackSpiritImage(true)")
    self._ui.stc_imageWalk:addInputEvent("Mouse_Out", "HandleEventOnOut_Equipment_All_ChangeBlackSpiritImage(false)")
    self._ui.stc_imageGo:addInputEvent("Mouse_On", "HandleEventOnOut_Equipment_All_ChangeBlackSpiritImage(true)")
    self._ui.stc_imageGo:addInputEvent("Mouse_Out", "HandleEventOnOut_Equipment_All_ChangeBlackSpiritImage(false)")
    if nil ~= PaGlobal_TransferPage_Open then
      self._ui.stc_imageWalk:addInputEvent("Mouse_LUp", "PaGlobal_TransferPage_Open()")
      self._ui.stc_imageGo:addInputEvent("Mouse_LUp", "PaGlobal_TransferPage_Open()")
    end
  end
