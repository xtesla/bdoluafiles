function PaGlobal_Equipment_All:prepareOpen()
  ...
  local showTransferIcon = false
  if true == _ContentsGroup_TransferEventBuff then
    PaGlobal_Equipment_All._ui.stc_blackSpiritBackImage:SetShow(true)
    ...
    PaGlobal_Equipment_All._ui.stc_blackSpiritBackImage:SetShow(false)
  ...
  if true == selfPlayer:get():isSeasonCharacter() and 10 <= selfPlayer:get():getLevel() then
    ...
    if true == showTransferIcon then
      PaGlobal_Equipment_All._ui.stc_seasonBannerPass:SetSpanSize(PaGlobal_Equipment_All._ui.stc_seasonBannerPass:GetSpanSize().x, 90)
      PaGlobal_Equipment_All._ui.stc_seasonBannerReward:SetSpanSize(PaGlobal_Equipment_All._ui.stc_seasonBannerReward:GetSpanSize().x, 180)
    else
      PaGlobal_Equipment_All._ui.stc_seasonBannerPass:SetSpanSize(PaGlobal_Equipment_All._ui.stc_seasonBannerPass:GetSpanSize().x, 0)
      PaGlobal_Equipment_All._ui.stc_seasonBannerReward:SetSpanSize(PaGlobal_Equipment_All._ui.stc_seasonBannerReward:GetSpanSize().x, 90)
    end
  else
