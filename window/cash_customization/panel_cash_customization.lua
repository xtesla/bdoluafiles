...
function ToClient_CashCumaBuy_Confirm_Do()
  ...
  elseif CashCumaBuy.ApplyType == "goods" then
    ToClient_requestBuyItem(CashCustomizationData[self.SelectedItemNo].productNo, 1, CashCustomizationData[self.SelectedItemNo].pearlPrice, CppEnums.BuyItemReqTrType.eBuyItemReqTrType_UiUpdate, toInt64(0, -1), 0, 0)
  elseif CashCumaBuy.ApplyType == "pearl" then
    ToClient_requestBuyItem(CashCustomizationData[self.SelectedItemNo].productNo, 1, CashCustomizationData[self.SelectedItemNo].cashPrice, CppEnums.BuyItemReqTrType.eBuyItemReqTrType_UiUpdate, toInt64(0, -1), 0, 0)
  else
    ToClient_requestBuyItem(CashCustomizationData[self.SelectedItemNo].productNo, 1, CashCustomizationData[self.SelectedItemNo].pearlPrice, CppEnums.BuyItemReqTrType.eBuyItemReqTrType_ImmediatelyUse, toInt64(0, -1), 0, 0)
  end
end
