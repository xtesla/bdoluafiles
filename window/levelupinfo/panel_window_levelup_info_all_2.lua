...
function PaGlobalFunc_Levelup_Info_All_SelfPlayerLevelUp_StatusDataSet(hp, mp, stun, weight, lvdd, lvpv)
  ...
  elseif __eClassType_Warrior == isMyClassType or __eClassType_Giant == isMyClassType or __eClassType_Lhan == isMyClassType or __eClassType_Combattant == isMyClassType or __eClassType_Mystic == isMyClassType or __eClassType_BladeMaster == isMyClassType or __eClassType_BladeMasterWoman == isMyClassType or __eClassType_Kunoichi == isMyClassType or __eClassType_NinjaMan == isMyClassType or __eClassType_Guardian == isMyClassType then
    PaGlobal_Levelup_Info_All._ui._stcText_MaxMpTitle:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_LEVELUP_INFO_MAXFPUP"))
  elseif __eClassType_Sorcerer == isMyClassType or __eClassType_WizardWoman == isMyClassType or __eClassType_WizardMan == isMyClassType or __eClassType_Tamer == isMyClassType or __eClassType_DarkElf == isMyClassType or __eClassType_Hashashin == isMyClassType or __eClassType_ReservedBlackSpirit == isMyClassType or __eClassType_Sorcerer_Reserved1 == isMyClassType then
    PaGlobal_Levelup_Info_All._ui._stcText_MaxMpTitle:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_LEVELUP_INFO_MAXMPUP"))
  elseif __eClassType_Valkyrie == isMyClassType or __eClassType_Nova == isMyClassType then
