...
function PaGlobalFunc_PetInfo_SetPetSkillTextByType(PcPetData, skillNo)
  ...
  if CppEnums.PetSkillType.Looting == skillParam._type then
    ...
    paramText = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_PETINFO_PETSKILLTYPE_ITEMGETTIME", "itemGetTime", string.format("%.2f", math.floor(variableCount / 10) / 100))
