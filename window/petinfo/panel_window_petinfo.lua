...
function PetInfo:Update(isSealed)
  local function petSkillType(PcPetData, param)
    ...
    if 1 == skillParam._type then
      ...
      paramText = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_PETINFO_PETSKILLTYPE_ITEMGETTIME", "itemGetTime", string.format("%.2f", math.floor(skillParam:getParam(0) * variableCount / 10) / 100))
