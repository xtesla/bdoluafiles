...
function PaGlobal_PetList_All:setUnsealPetContents(uiControls, groupBtns, skillIcon, petNo64, pcPetData, index, isFusion)
  ...
  PaGlobal_PetList_UpdateControlIconInfo_All(petNo_s64, self._petOrderList._follow[tostring(petNo_s64)], self._petOrderList._find[tostring(petNo_s64)], self._petOrderList._getItem[tostring(petNo_s64)])
