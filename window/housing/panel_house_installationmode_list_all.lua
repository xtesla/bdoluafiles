PaGlobal_House_InstallationList_All = {
  _ui = {
    ...
    _stc_bigHousePartList = nil,
    _stc_bigHouseLeftButton = nil,
    _stc_bigHousePartTemplate = nil,
    _stc_bigHouseRightButton = nil,
    _stc_bigHouseItemListBg = nil,
    _stc_bigHouseItemTemplete = nil,
    _scroll_bigHouseItemList = nil,
    _pc = {
  ...
  _initialize = false,
  _isMansion = false,
  _mansionCharacterKey = 0,
  _maxMansionPartCount = 0,
  _prevSelectPart = -1,
  _mansionPartSlotUIPool = {},
  _startPartPos = {x = 0, y = 0},
  _maxViewPartsCount = 4,
  _currentViewIndex = 0,
  _mansionSlotUIPool = {},
  _mansionItemSlotCol = 8,
  _mansionItemSlotRow = 3,
  _mansionItemStartPos = {x = 0, y = 0}
}
