function PaGlobal_WarInfomation_All:initialize()
  ...
  if true == _ContentsGroup_SiegeInstallation and false == self._isConsole then
...
function PaGlobal_WarInfomation_All:resize()
  ...
  if true == _ContentsGroup_SiegeInstallation and false == self._isExpandMode and false == self._isOpenFromWorldMap then
...
function PaGlobal_WarInfomation_All:updateExpandMode(isExpandMode)
  if false == _ContentsGroup_SiegeInstallation then
    return
  end
