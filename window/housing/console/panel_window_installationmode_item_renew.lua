...
function Panel_Window_InstallationMode_Item_info:open()
  ...
  if true == _ContentsGroup_SiegeInstallation and nil ~= Panel_House_InstallationMode_Siege_All and true == Panel_House_InstallationMode_Siege_All:GetShow() then
    isSiegeKitMode = true
  end
...
function FromClient_ChangeHousingInstallMode_Item_Renew(preMode, nowMode)
  ...
  if true == _ContentsGroup_SiegeInstallation and nil ~= PaGlobal_House_InstallationSiege_All_SetKeyGuide then
