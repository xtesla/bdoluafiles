...
function Panel_Window_PartySetting_info:setBigIcon(index)
  ...
  if nil ~= self._texture_Big[classType] then
    ...
    if __eClassType_ShyWaman == classType or __eClassType_Hashashin == classType or __eClassType_Guardian == classType or __eClassType_Nova == classType or __eClassType_ReservedBlackSpirit == classType or __eClassType_Sorcerer_Reserved1 == classType then
