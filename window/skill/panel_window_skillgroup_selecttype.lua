PaGlobal_SkillGroup_SelectType = {
  ...
  _classDataList = {
    ...
    [__eClassType_Nova] = {
      [__eSkillTypeParam_Awaken] = {
        _texture = "Combine/Etc/Combine_Etc_Skill_Awaken_Nova.dds",
        _weaponType = "LUA_NOVA_AWAKEN_WEAPON_TYPE",
        _combatType = "LUA_NOVA_AWAKEN_COMBAT_TYPE",
        _desc = "LUA_NOVA_AWAKEN_DESC"
      },
      [__eSkillTypeParam_Inherit] = {
        _texture = "Combine/Etc/Combine_Etc_Skill_Succesion_Nova.dds",
    ...
    [__eClassType_ReservedBlackSpirit] = {
      [__eSkillTypeParam_Awaken] = {
        _texture = "Combine/Etc/Combine_Etc_Skill_Awaken_Sage.dds",
        _weaponType = "LUA_SAGE_AWAKEN_WEAPON_TYPE",
        _combatType = "LUA_SAGE_AWAKEN_COMBAT_TYPE",
        _desc = "LUA_SAGE_AWAKEN_DESC"
      },
      [__eSkillTypeParam_Inherit] = {
        _texture = "Combine/Etc/Combine_Etc_Skill_Succesion_Sage.dds",
