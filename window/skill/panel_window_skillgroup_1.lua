...
function PaGlobal_SkillGroup:controlInit_All()
  ...
  if true == _ContentsGroup_SkillPreset then
    ...
    for index = 0, self._presetSlotMaxCount - 1 do
      ...
      if true == self._isConsole then
        self._skillPreset.btn_preset[index]:registerPadEvent(__eConsoleUIPadEvent_Up_X, "PaGlobalFunc_SkillPresetMemo_Open(" .. tostring(index) .. ")")
      else
        self._skillPreset.btn_preset[index]:addInputEvent("Mouse_RUp", "PaGlobalFunc_SkillPresetMemo_Open(" .. tostring(index) .. ")")
      end
    end
...
function PaGlobal_SkillGroup:open()
  ...
  self._isReverseSkillType = false
  if __eClassType_ReservedBlackSpirit == classType or __eClassType_Sorcerer_Reserved1 == classType then
    self._isReverseSkillType = true
  end
  if true == _ContentsGroup_SkillFilter then
...
function PaGlobal_SkillGroup:createSkillGroupControls(tableWrapper, parent, tab)
  ...
  for index = 0, subGroupSize - 1 do
    ...
    self._subGroupList[tab][index] = {_name = strKey, _use = true}
  end
