...
function PaGlobal_SpiritEnchant_All:resizePanel_EnchantTabNew()
  ...
  if true == self._ui_enchant.stc_buttonArea:GetShow() then
    if true == self._ui_enchant.chk_enchantCron:GetShow() or true == self._ui_enchant.chk_enchantDefenceFail:GetShow() or true == self._ui_enchant.btn_stackChange:GetShow() then
  ...
  if true == self._ui_enchant.chk_skipAni:GetShow() then
  ...
  if true == self._ui_pc.btn_enchantGo:GetShow() or true == self._ui_console.stc_enchantGoY:GetShow() then
  ...
  if true == self._ui_enchant.radio_enchantNormal:GetShow() then
    Panel_Window_StackExtraction_All:SetPosY(self._originPanelPosY - self._ui_enchant.txt_enchantDesc:GetTextSizeY())
  else
    Panel_Window_StackExtraction_All:SetPosY(self._originPanelPosY)
  end
end
