...
function HandleEventLUp_SpiritEnchant_All_DefenceFailClick()
  ...
  if CppEnums.ItemClassifyType.eItemClassify_Accessory == itemStaticWrapper:getItemClassify() and false == isSpecialEnchantItem then
...
function PaGlobal_SpiritEnchant_All_SetAdditionalEnchantRate()
  ...
  local failCount = PaGlobal_SpiritEnchant_All._enchantInfo:ToClient_getFailCount() * -1
  local valksCount = PaGlobal_SpiritEnchant_All._enchantInfo:ToClient_getValksCount() * -1
  ...
  local rate = currentRate - addedRate
