...
function Panel_Window_StableExchange_info:setMatingSlot(slotNo)
  ...
  self._ui.staticText_Tier_Mating_Right:SetText("")
  local tierName = auctionServantInfo:getDisplayTierName()
  if nil ~= tierName then
    self._ui.staticText_Tier_Mating_Right:SetText(tierName)
  end
