...
function PaGlobal_ServantMarket_All:MarketServant_Tooltip_Open(actorKeyRaw, key32, slotIdx)
  ...
  local servantListIndex = slotIdx
  if nil ~= self._isTabMyRegister and true == self._isTabMyRegister then
    servantListIndex = self._selectPage * self._MAXSLOTCOUNT + slotIdx
  end
