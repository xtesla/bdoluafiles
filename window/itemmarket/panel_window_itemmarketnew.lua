...
function Itemmarket_SpecialListUpdate(contents, key)
  ...
  if true == self.isGrouplist then
    ...
    if nil ~= itemMarketSummaryInfo then
      ...
      elseif enchantLevel > 0 and CppEnums.ItemClassifyType.eItemClassify_Accessory == itemMarketSummaryInfo:getItemClassify() and false == itemMarketSummaryInfo:isSpecialEnchantItem() then
