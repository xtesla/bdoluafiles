function PaGlobal_Quest_All:resetDataArray()
  ...
  self._questSortArrayType = {
    ...
    [CppEnums.QuestType.eQuestType_Production] = {}
  }
  self._questArrayTypeCount = {
    ...
    [CppEnums.QuestType.eQuestType_Production] = 0
  }
    ...
    for index = 0, regionCount do
      do
        ...
        local function doInsertData()
          ...
          arrayIdx = arrayIdx + 1
          if true == self._regionOpen[regionIdx] and count > 0 then
    ...
    for typeIdx = 0, typeCount do
      do
        ...
        local function doInsertData()
          ...
          arrayIdx = arrayIdx + 1
          if true == self._typeOpen[typeIdx] and count > 0 then
            for questIdx = 0, count - 1 do
              self._useArray[arrayIdx] = {
                isQuest = true,
