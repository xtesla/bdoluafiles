  ...
  elseif CppEnums.CountryType.NA_ALPHA == getGameServiceType() then
    ...
    if 1 == webServiceType or 4 == webServiceType then
      if 1 == nationType then
        url = "https://alphaqa-eu-game-portal.naeu.playblackdesert.com/Banner/BottomBanner"
      else
        url = "https://alphaqa-na-game-portal.naeu.playblackdesert.com/Banner/BottomBanner"
      end
    elseif 1 == nationType then
      url = "https://beta-eu-game-portal.naeu.playblackdesert.com/Banner/BottomBanner"
    else
      url = "https://beta-na-game-portal.naeu.playblackdesert.com/Banner/BottomBanner"
    end
  elseif CppEnums.CountryType.NA_REAL == getGameServiceType() then
    local nationType = getServiceNationType()
    if 1 == nationType then
      url = "https://eu-game-portal.naeu.playblackdesert.com/Banner/BottomBanner"
    else
      url = "https://na-game-portal.naeu.playblackdesert.com/Banner/BottomBanner"
    end
  else
...
function PaGloabl_Banner_GetBloodAltarURL()
  ...
  elseif CppEnums.CountryType.NA_ALPHA == getGameServiceType() then
    ...
    if 1 == webServiceType or 4 == webServiceType then
      if 1 == nationType then
        url = "https://alphaqa-eu-game-portal.naeu.playblackdesert.com/CashShop/Banner/BottomBanner"
      else
        url = "https://alphaqa-na-game-portal.naeu.playblackdesert.com/CashShop/Banner/BottomBanner"
      end
    elseif 1 == nationType then
      url = "https://beta-eu-game-portal.naeu.playblackdesert.com/CashShop/Banner/BottomBanner"
    else
      url = "https://beta-na-game-portal.naeu.playblackdesert.com/CashShop/Banner/BottomBanner"
    end
  elseif CppEnums.CountryType.NA_REAL == getGameServiceType() then
    local nationType = getServiceNationType()
    if 1 == nationType then
      url = "https://eu-game-portal.naeu.playblackdesert.com/CashShop/Banner/BottomBanner"
    else
      url = "https://na-game-portal.naeu.playblackdesert.com/CashShop/Banner/BottomBanner"
    end
  end
  return url
end
