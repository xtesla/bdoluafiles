...
function PaGlobal_SailorManager_All:ConsoleKeySetting()
  ...
  if true == self._isOpenByESCMenu then
    ...
    Panel_Window_SailorManager_All:registerPadEvent(__eConsoleUIPadEvent_Up_X, "PaGlobal_SailorOnBoard_All:prepareOpen()")
