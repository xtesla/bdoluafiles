...
function PaGlobal_FairyInfo_All:toggleEnableSkinSkill(showParam)
  if true == showParam then
    ...
    self._ui.stc_SkillBG:SetSpanSize(self._ui.stc_SkillBG:GetSpanSize().x, self._skinSkillBG_SpanSizeY)
  else
    self._ui.stc_SkinSkillBG:SetShow(false)
    self._ui.stc_SkillBG:SetSpanSize(self._ui.stc_SkillBG:GetSpanSize().x, self._defaultSkillBG_SpanSizeY)
  end
end
