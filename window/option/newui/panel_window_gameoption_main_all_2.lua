...
function PaGlobal_GameOption_All_UpdateRemasterUI()
  if nil ~= Panel_Window_UIModify_All and true == PaGlobal_GameOption_All._isClickedRemasterBtn then
    ...
    PaGlobal_GameOption_All._isClickedRemasterBtn = false
  end
end
