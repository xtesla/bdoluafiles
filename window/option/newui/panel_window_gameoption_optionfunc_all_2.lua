...
function PaGlobal_GameOption_All._elements.DetachtedHpBar:set(value)
  PaGlobal_GameOption_All._isClickedRemasterBtn = true
  ToClient_getGameUIManagerWrapper():setLuaCacheDataListBool(__eSwapRemasterUISetting, not value, CppEnums.VariableStorageType.eVariableStorageType_User)
end
