        ...
        for subidx = 1, #self._ui.stc_life[idx]._subLifeType do
          ...
          if nil ~= stringTable then
            ...
            if false == self._isConsole then
              ...
              self._ui.stc_life[idx]._subLifeType[subidx]._subtitle:addInputEvent("Mouse_On", "HandleEventOnOut_CharInfoLife_All_LifeType_Tooltip(true," .. tostring(idx) .. "," .. tostring(subidx) .. ",false)")
