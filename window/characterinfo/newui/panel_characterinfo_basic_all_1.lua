...
function PaGlobal_CharInfoBasic_All:setUnChangedData()
  ...
  elseif __eClassType_Sorcerer == classType or __eClassType_Tamer == classType or __eClassType_WizardMan == classType or __eClassType_WizardWoman == classType or __eClassType_Hashashin == classType or __eClassType_ReservedBlackSpirit == classType or __eClassType_Sorcerer_Reserved1 == classType then
...
function PaGlobal_CharInfoBasic_All:setClassIcon(control, classType)
  ...
  elseif classType == __eClassType_Nova then
    x1, y1, x2, y2 = setTextureUV_Func(control, 229, 286, 285, 342)
  elseif classType == __eClassType_ReservedBlackSpirit then
    x1, y1, x2, y2 = setTextureUV_Func(control, 286, 286, 342, 342)
  elseif classType == __eClassType_Sorcerer_Reserved1 then
    x1, y1, x2, y2 = setTextureUV_Func(control, 343, 286, 399, 342)
  end
...
function PaGlobal_CharInfoBasic_All:setAtkType()
  ...
  if isClassType == __eClassType_Warrior or isClassType == __eClassType_Guardian or isClassType == __eClassType_Lhan or isClassType == __eClassType_Giant or isClassType == __eClassType_ShyWaman or isClassType == __eClassType_Combattant or isClassType == __eClassType_BladeMaster or isClassType == __eClassType_BladeMasterWoman or isClassType == __eClassType_Mystic or isClassType == __eClassType_Valkyrie or isClassType == __eClassType_Kunoichi or isClassType == __eClassType_NinjaMan or isClassType == __eClassType_Nova or isClassType == __eClassType_Sorcerer_Reserved1 then
    self._ui.txt_AtkTypeRegist:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_WARRIOR_AWAKEN_COMBAT_TYPE"))
  elseif isClassType == __eClassType_ElfRanger or isClassType == __eClassType_RangerMan then
    self._ui.txt_AtkTypeRegist:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_RANGER_SUCCESSION_COMBAT_TYPE"))
  elseif isClassType == __eClassType_Hashashin or isClassType == __eClassType_Sorcerer or isClassType == __eClassType_Tamer or isClassType == __eClassType_DarkElf or isClassType == __eClassType_WizardMan or isClassType == __eClassType_WizardWoman or isClassType == __eClassType_ReservedBlackSpirit then
