...
function PaGlobal_MarketPlaceSell_Req()
  ...
  local function sellExcute()
    ...
    _PA_LOG("\236\181\156\237\149\156\236\167\132", "" .. tostring(lastOtpConfirm) .. " ::::: " .. tostring(utcTime))
  ...
  local function checkbox_sell()
    ...
    local lastOtpConfirm = getWorldMarketLastOtpConfirm()
    local utcTime = Int64toInt32(getUtc64())
    _PA_LOG("\236\181\156\237\149\156\236\167\132", "isOtpItem : " .. tostring(self._isOtpItem) .. " ContentsGroup_WorldMarketOTP :" .. tostring(_ContentsGroup_WorldMarketOTP))
    if true == self._isOtpItem and lastOtpConfirm < utcTime and true == _ContentsGroup_WorldMarketOTP then
...
function Update_MarketPlaceSell_HoverPrice(deltatime)
  ...
  local price = self._graph.priceArray[currentIndex]
  if nil ~= price then
    hoverControl:SetText(makeDotMoney(price))
  end
end
