...
function HandleEventLUp_GameExit_All_ChangeCharacter(index)
  ...
  if true == _ContentsGroup_CharacterTag and ToClient_GetMyDuelCharacterIndex() == index then
  ...
  if true == ToClient_isEventChannel() and false == characterData._isEventCharacter and false == ToClient_SelfPlayerIsGM() then
