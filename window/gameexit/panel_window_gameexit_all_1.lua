function PaGlobal_GameExit_All:initialize()
  ...
  self._ui._stc_transferBanner_NA = UI.getChildControl(Panel_Window_GameExit_All, "Static_TransferBanner")
  self._ui._btn_transferBanner_NA = UI.getChildControl(self._ui._stc_transferBanner_NA, "Button_1")
  local characterDatacount = getCharacterDataCount() + 1
  local rowCount = math.ceil(characterDatacount / self._config.slotCols)
...
function PaGlobal_GameExit_All:registEventHandler()
  ...
  self._ui._btn_transferBanner_NA:addInputEvent("Mouse_LUp", "PaGlobal_NA_Common_TransferLink()")
end
function PaGlobal_GameExit_All:prepareOpen()
  ...
  self._ui._stc_transferBanner_NA:SetShow(false)
  local uiCount = 0
...
function PaGlobal_GameExit_All:updateCharacterSlot(startIdx)
  ...
  for idx = startIdx, characterDatacount - 1 do
    ...
    if __eTUserCharacterNoDefault ~= characterData._duelCharacterNo then
