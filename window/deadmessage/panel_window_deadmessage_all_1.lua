...
function PaGlobal_DeadMessage_All:registerEventHandler()
  ...
  PaGlobal_DeadMessage_All._ui.btn_specUpGuideIcon:addInputEvent("Mouse_LUp", "HandleEventLUp_DeadMessage_All_ShowSpecUpGuide()")
