...
function PaGlobalFunc_DeadMessage_All_ButtonPushEvent_InSiegeingFortress()
  ...
  local currentBuildInfo
  if false == _ContentsGroup_ConquestSiege then
    currentBuildInfo = ToClient_getCurrentBuildingInfo()
  else
    currentBuildInfo = ToClient_getCurrentBuildingInfoForConquestRule()
  end
...
function PaGlobalFunc_DeadMessage_All_ButtonPushEvent_Atoraxion()
  ...
  deadMessage_Revival(__eRespawnType_Atoraxion, 255, 0, getSelfPlayer():getRegionKey(), false, toInt64(0, 0))
end
