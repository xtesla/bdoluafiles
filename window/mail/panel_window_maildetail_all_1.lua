...
function PaGlobal_Window_MailDetail_All:prepareOpen(mailNo)
  ...
  if true == self._isConsole and true == _ContentsGroup_NewUI_TotalReward_All and nil ~= Panel_Window_TotalReward_All and true == Panel_Window_TotalReward_All:GetShow() then
