...
function GuildLetsWarPage:setDesc()
  if nil == Panel_Guild_Declaration then
    return
  end
  ...
  if false == _ContentsGroup_ApplyGuildWarPenaltyOption then
    self._txtLetsWarHelp:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_GUILD_TEXT_LETSWARHELP_NEW", "money", makeDotMoney(needMoney)))
  else
    ...
    self._txtLetsWarHelp:SetText(desc)
  end
end
