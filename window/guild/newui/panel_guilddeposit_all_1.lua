function PaGlobal_GuildDeposit_All:initialize()
  ...
  self._ui.stc_deposit_console = UI.getChildControl(self._ui.stc_mainArea, "temp_Search_GuildForConsole")
...
function PaGlobal_GuildDeposit_All:validate()
  ...
  self._ui.stc_deposit_console:isValidate()
end
function PaGlobal_GuildDeposit_All:registEvent()
  ...
  elseif true == _ContentsGroup_RenewUI then
    self._ui.edit_deposit:SetIgnore(true)
    self._ui.stc_deposit_console:SetIgnore(false)
    self._ui.stc_deposit_console:addInputEvent("Mouse_LUp", "HandlleEventPadUp_Deposit_SetDeposit()")
  else
