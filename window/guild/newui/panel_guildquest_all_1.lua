...
function PaGlobal_GuildQuest_All:updateProgressQuest()
  ...
  local isRightQuestComplete = PaGlobalFunc_GuildQuest_All_RightCheck(__eGuildRightType_QuestComplete)
...
function PaGlobal_GuildQuest_All:updateCurrentPage()
  ...
  local isRightQuestAccept = PaGlobalFunc_GuildQuest_All_RightCheck(__eGuildRightType_QuestAccept)
