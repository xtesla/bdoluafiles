...
function PaGlobalFunc_AgreementGuild_Master_ContractOpen(memberIdx, requesterMemberGrade, usaAbleActivity)
  ...
  local isRenew = false
  isRenew = PaGlobalFunc_AgreementGuildMaster_RightCheck(__eGuildRightType_Contract, memberIdx, requesterMemberGrade)
...
function PaGlobalFunc_AgreementGuildMaster_RightCheck(eRightType, memberIdx, requesterMemberGrade)
  ...
  if __eGuildMemberGradeAdviser == requesterMemberGrade and true == memberInfo:isSelf() then
    return true
  end
