function PaGlobal_GuildInfo_All:initialize()
  ...
  if false == _ContentsGroup_RenewUI and false == self._isKR2 then
...
function PaGlobal_GuildInfo_All:swichPlatform(isUsePad)
  ...
  self._ui.stc_MarkBg:SetShow(not self._isConsole and not self._isKR2)
  self._ui.txt_TadayCommentTitle:SetShow(not isUsePad and not self._isKR2)
  self._ui.stc_QuestionWar:SetShow(not isUsePad)
  self._ui.stc_ConsoleOnly:SetShow(isUsePad)
  self._ui.stc_KeyGuide_LT:SetShow(isUsePad)
  self._ui.stc_KeyGuide_RT:SetShow(isUsePad)
  self._ui.stc_GuildMark_Console:SetShow(self._isConsole or self._isKR2)
  self._ui.stc_GuildBg_Console:SetShow(self._isConsole or self._isKR2)
  self._ui.btn_ItemShare:SetShow(_ContentsGroup_GuildShareItemWareHouse and false == _ContentsGroup_UsePadSnapping)
...
function PaGlobal_GuildInfo_All:checkShowButton(guildWrapper)
  ...
  local isRightGetMaster = true == PaGlobalFunc_GuildInfo_All_RightCheck(__eGuildRightType_GetMaster) or true == PaGlobalFunc_GuildInfo_All_RightCheck(__eGuildRightType_GetMasterLowGrade)
  ...
  local isRightGuildRecruit = PaGlobalFunc_GuildInfo_All_RightCheck(__eGuildRightType_Recruitment)
  ...
  local isRightIncreaseProtectedCount = PaGlobalFunc_GuildInfo_All_RightCheck(__eGuildRightType_ChangeProtectMemberCount)
  ...
  local isRightArsha = PaGlobalFunc_GuildInfo_All_RightCheck(__eGuildRightType_Competition)
  ...
  local isRightMarkChange = PaGlobalFunc_GuildInfo_All_RightCheck(__eGuildRightType_SetGuildMark)
  self._ui.btn_MarkChange:SetShow(isRightMarkChange)
  local isRightGradeUp = PaGlobalFunc_GuildInfo_All_RightCheck(__eGuildRightType_ChangeMemberMaxCount)
  self._ui.btn_GradeUp:SetShow(isRightGradeUp)
  local isRightNotice = PaGlobalFunc_GuildInfo_All_RightCheck(__eGuildRightType_Notice)
  self._ui.edit_Notice:SetIgnore(not isRightNotice)
...
function PaGlobal_GuildInfo_All:warInfoUpdateByList2(contents, key)
  ...
  local isRightGuildWar = PaGlobalFunc_GuildInfo_All_RightCheck(__eGuildRightType_GuildWar)
...
function PaGlobal_GuildInfo_All:guildServerNameUpdate(guildWrapper)
  ...
  if true == self._ui.txt_GuildServerName:IsLimitText() then
    self._ui.stc_GuildServer:addInputEvent("Mouse_On", "HandleEventOnOut_GuildInfo_All_ShowGuildServerTooltip( true )")
    self._ui.stc_GuildServer:addInputEvent("Mouse_Out", "HandleEventOnOut_GuildInfo_All_ShowGuildServerTooltip( false )")
  end
end
function PaGlobal_GuildInfo_All:guildTodayCommentUpdate(guildWrapper)
  ...
  local isRightCommentAdmin = PaGlobalFunc_GuildInfo_All_RightCheck(__eGuildRightType_TodayCommentAdmin)
  local isAdmin = 0
  if true == isRightCommentAdmin then
    isAdmin = 1
  end
  if nil ~= guildCommentsWebUrl and false == self._isUsePad and false == self._isKR2 then
