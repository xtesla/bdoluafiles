...
function PaGlobal_GuildVolunteerList_All:ControlAll_Init()
  ...
  self._ui.btn_warReward:SetShow(PaGlobalFunc_GuildMain_All_CheckIsMecernary())
end
...
function PaGlobal_GuildVolunteerList_All:updateListMemeber(member, index)
  ...
  local isRightVolunteerMenu = PaGlobalFunc_GuildVolunteerList_All_RightCheck(__eGuildRightType_SetMemberLimitPrice)
  ...
  local isRightContract = PaGlobalFunc_GuildVolunteerList_All_RightCheck(__eGuildRightType_Contract)
  local padding = 10
