...
function PaGlobal_GuildMain_All:alignTabButton()
  ...
  local isRightRecruit = PaGlobalFunc_GuildMain_All_RightCheck(__eGuildRightType_Recruitment)
...
function PaGlobal_GuildMain_All:checkCurTabOpen(idx)
  ...
  elseif idx == self._eTABINDEX._GUILDBATTLE and (false == ToClient_isGuildBattle() or true == ToClient_isEventChannel()) then
    self._tabData[idx].btn:SetCheck(false)
    self._tabData[self._currentTabIdx].btn:SetCheck(true)
