function PaGlobal_Guild_ManufactureSelect_All:initialize()
  ...
  if true == _ContentsGroup_SummonGuildDrill then
    PaGlobal_Guild_ManufactureSelect_All._categoryList[4] = PAGetString(Defines.StringSheet_GAME, "LUA_GUILD_MANUFACTURE_SELECT_CATEGORY4")
  end
...
function PaGlobal_Guild_ManufactureSelect_All:slotInit()
  ...
  for ii = 0, #productEnchantKeyList do
    ...
    if nil ~= manufactureStatic then
      ...
      if nil ~= self._category[categoryNo] then
        local slot = {}
...
function PaGlobal_Guild_ManufactureSelect_All:updateSlot()
  ...
  for ii = 0, #productEnchantKeyList do
    ...
    if nil ~= PaGlobal_Guild_ManufactureSelect_All._slotList[ii + 1] then
