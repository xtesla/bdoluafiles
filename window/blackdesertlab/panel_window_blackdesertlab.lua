...
function PaGlobal_BlackDesertLab_Show()
  ...
  self._url = tostring(ToClient_getGTAccountURL()) .. "/GlobalLabRegister?isTester=" .. tostring(ToClient_isCompleteTesterSubmit())
  _PA_LOG("\237\151\136\236\158\172\236\132\157", "PaGlobal_BlackDesertLab URL : " .. tostring(self._url))
