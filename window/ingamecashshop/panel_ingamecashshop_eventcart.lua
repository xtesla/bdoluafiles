...
function IngameCashShopEventCart_Init()
  ...
  if false == _ContentsGroup_PearlShopGift then
    self.btn_Confirm:SetSpanSize(-70, 10)
    self.btn_Cancle:SetSpanSize(70, 10)
  end
...
function IngameCashShopEventCart_registEventHandler()
  ...
  if true == self.isConsole then
    ...
    Panel_IngameCashShop_EventCart:registerPadEvent(__eConsoleUIPadEvent_RT, "IngameCashShopEventCart_Gift()")
  else
