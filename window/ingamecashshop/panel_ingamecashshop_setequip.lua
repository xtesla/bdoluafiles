...
function PaGlobalFunc_IngameCashShopSetEquip_RightTopBtnAlign()
  ...
  local btnList = {
    ...
    [2] = CashShopController.btn_StampCoupon,
    [3] = CashShopController.btn_FirstIgnore,
    [4] = CashShopController.btn_SaleGoods,
    [5] = CashShopController.btn_Mileage,
    [6] = CashShopController.btn_GuildGiveaway
  }
