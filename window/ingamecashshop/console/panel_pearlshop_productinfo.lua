...
function pearlShopProductInfo:initialize()
  ...
  self._ui._bannerControl = UI.getChildControl(self._ui._mainBgControl, "Static_ProductBanner")
...
function pearlShopProductInfo:update()
  ...
  self._ui._titleControl:SetPosY(self._ui._titleControl:GetPosY() + addBannerSizeY)
