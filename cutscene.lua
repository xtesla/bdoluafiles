...
function FromClient_PlayCutScene(cutSceneName, isFromServer)
  ...
  txt_keyGuideB:SetShow(_ContentsGroup_UsePadSnapping)
  if true == _ContentsGroup_UsePadSnapping then
  ...
  if true == _ContentsGroup_Production and true == ToClient_IsDevelopment() then
    FromClient_Production_Main_StartProduction()
  end
...
function FromClient_StopCutScene(cutSceneName)
  ...
  if true == _ContentsGroup_Production and true == ToClient_IsDevelopment() then
    FromClient_Production_Main_EndProduction()
  end
