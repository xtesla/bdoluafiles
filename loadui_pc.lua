...
function loadLoadingUI_PC()
  if true == ToClient_isAnotherLoading() then
    return
  end
...
function preLoadGameUI_PC()
  ...
  loadUI("UI_Data/Window/WebHelper/Panel_WebControl.XML", "Panel_WebControl", UIGroup.PAGameUIGroup_Production_Modify, SETRENDERMODE_BITSET_ALLRENDER())
  ...
  if _ContentsGroup_ExpirienceWiki_All then
    if _ContentsGroup_WikiNoToURL then
      loadUI("UI_Data/Window/ExpirienceWiki/Panel_Window_ExpirienceWiki_All.xml", "Panel_Window_ExpirienceWiki_All", UIGroup.PAGameUIGroup_Production_Modify, PAUIRenderModeBitSet({
        RenderMode.eRenderMode_Default,
        RenderMode.eRenderMode_Dialog
      }))
    else
  ...
  basicLoadUI("UI_Data/Window/Cop/Panel_Window_Knave_Report.XML", "Panel_Window_Knave_Report", UIGroup.PAGameUIGroup_Windows)
  basicLoadUI("UI_Data/Window/Cop/Panel_Window_Cop_Rank.XML", "Panel_Window_Cop_Rank", UIGroup.PAGameUIGroup_Windows)
  ...
  loadUI("UI_Data/Window/ProductNote/Panel_ProductNote.XML", "Panel_ProductNote", UIGroup.PAGameUIGroup_Production_Modify, PAUIRenderModeBitSet({
    RenderMode.eRenderMode_Default,
    RenderMode.eRenderMode_Dialog
  }))
  basicLoadUI("UI_Data/Window/KeyboardHelp/Panel_KeyboardHelp.XML", "Panel_KeyboardHelp", UIGroup.PAGameUIGroup_Production_Modify, SETRENDERMODE_BITSET_ALLRENDER())
  ...
  if true == ToClient_IsDevelopment() then
    basicLoadUI("UI_Data/Actor/UI_Actor_NameTag_Monster.XML", "Panel_Copy_Monster", UIGroup.PAGameUIGroup_MainUI, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_CutScene
    }))
  else
  ...
  if true == _ContentsGroup_Production then
    loadUI("UI_Data/Window/Production/Panel_Window_LetterBox.XML", "Panel_Window_Production_Main", UIGroup.PAGameUIGroup_FadeScreen, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_CutScene,
      RenderMode.eRenderMode_GroupCamera,
      RenderMode.eRenderMode_Production
    }))
    loadUI("UI_Data/Window/Production/Panel_Window_Production_Movie.XML", "Panel_Window_Production_Movie", UIGroup.PAGameUIGroup_FadeScreen, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_GroupCamera,
      RenderMode.eRenderMode_Production
    }))
    loadUI("UI_Data/Widget/Production/Tutorial/Panel_Widget_NewTutorial_Key.XML", "Panel_Widget_NewTutorial_Key", UIGroup.PAGameUIGroup_Widget, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_GroupCamera,
      RenderMode.eRenderMode_Production
    }))
    loadUI("UI_Data/Widget/Production/Tutorial/Panel_Widget_NewTutorial_Quest.XML", "Panel_Widget_NewTutorial_Quest", UIGroup.PAGameUIGroup_Widget, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_GroupCamera,
      RenderMode.eRenderMode_Production
    }))
    loadUI("UI_Data/Widget/Production/Tutorial/Panel_Widget_NewTutorial_SkillGuide.XML", "Panel_Widget_NewTutorial_SkillGuide", UIGroup.PAGameUIGroup_Widget, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_GroupCamera,
      RenderMode.eRenderMode_Production
    }))
  ...
  if true == _ContentsGroup_sheriff then
    loadUI("UI_Data/Window/Cop/Panel_Window_Wanted.XML", "Panel_Window_Wanted", UIGroup.PAGameUIGroup_Windows, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_Dialog
    }))
    loadUI("UI_Data/Window/Cop/Panel_Window_Wanted_Set.XML", "Panel_Window_Wanted_Set", UIGroup.PAGameUIGroup_Window_Progress, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_Dialog
    }))
  end
...
function loadGameUI_PC()
  ...
  runLua("UI_Data/Script/QASupport/QASupportDamage_Hashashin.lua")
  runLua("UI_Data/Script/QASupport/QASupportDamage_Nova.lua")
  runLua("UI_Data/Script/QASupport/QASupportDamage_Sage.lua")
  ...
  runLua("UI_Data/Script/Window/Cop/Panel_Window_Knave_Report_All.lua")
  runLua("UI_Data/Script/Window/Cop/Panel_Window_Cop_Rank_All.lua")
  if true == _ContentsGroup_InstrumentPerformance then
  ...
  if true == _ContentsGroup_Production then
    runLua("UI_Data/Script/Window/Production/Panel_Window_Production_Main.lua")
    runLua("UI_Data/Script/Window/Production/Panel_Window_Production_Movie.lua")
    runLua("UI_Data/Script/Window/Production/Panel_Window_Production_Tutorial_Main.lua")
  end
  if true == _ContentsGroup_SelectBox then
  ...
  if true == _ContentsGroup_sheriff then
    runLua("UI_Data/Script/Window/Cop/Panel_Window_Wanted.lua")
    runLua("UI_Data/Script/Window/Cop/Panel_Window_Wanted_Set.lua")
  end
  if true == _ContentsGroup_CrewMatch then
