function PaGlobal_MiniGame_Gradient_All:initialize()
  ...
  PaGlobal_MiniGame_Gradient_All._ui.stc_Icon = UI.getChildControl(PaGlobal_MiniGame_Gradient_All._ui.stc_gaugeBar, "Static_Icon")
  PaGlobal_MiniGame_Gradient_All._ui.stc_HallowinIcon = UI.getChildControl(PaGlobal_MiniGame_Gradient_All._ui.stc_gaugeBar, "Static_Hallowin")
