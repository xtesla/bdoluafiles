...
function PaGlobal_MiniGame_GradientY_All_StartGame()
  ...
  if true == isHallowin then
    ...
    PaGlobal_MiniGame_GradientY_All._KeyTimeSpanMaxWeight = 0.22
    PaGlobal_MiniGame_GradientY_All._KeyTimeSpanMinWeight = 0.16
    PaGlobal_MiniGame_GradientY_All._speedWeight = 3.5
  else
