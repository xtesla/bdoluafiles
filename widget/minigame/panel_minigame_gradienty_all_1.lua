function PaGlobal_MiniGame_GradientY_All:initialize()
  ...
  PaGlobal_MiniGame_GradientY_All._ui.stc_icon = UI.getChildControl(PaGlobal_MiniGame_GradientY_All._ui.stc_gaugeBar, "Static_Icon")
  PaGlobal_MiniGame_GradientY_All._ui.stc_hallowinIcon = UI.getChildControl(PaGlobal_MiniGame_GradientY_All._ui.stc_gaugeBar, "Static_Hallowin")
