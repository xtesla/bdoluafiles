...
function PaGlobal_MaidList_All:controlAll_Init()
  ...
  if true == self._isConsole then
    ...
    self._ui.txt_maidCount:SetHorizonRight()
    self._ui.txt_maidCountValue:SetHorizonRight()
    self._ui.chk_UseMultiMaid:ComputePos()
    local maidCountGapX = 50
    local maidCountValueGapX = 20
    self._ui.txt_maidCount:SetSpanSize(maidCountGapX, self._ui.txt_maidCount:GetSpanSize().y)
    self._ui.txt_maidCountValue:SetSpanSize(maidCountValueGapX, self._ui.txt_maidCountValue:GetSpanSize().y)
    self._ui.chk_UseMultiMaid:SetSpanSize(self._ui.chk_UseMultiMaid:GetSpanSize().x, self._ui.txt_maidCountValue:GetSpanSize().y)
  else
