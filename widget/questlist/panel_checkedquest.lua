...
function HandleClieked_GuildQuestWidget_Giveup()
  local isRightGuildQuestComplete = PaGlobalFunc_CheckedQuest_All_RightCheck(__eGuildRightType_QuestComplete)
      ...
      if nil ~= temp_questGroupInfo then
        if true == temp_questGroupInfo:isGroupQuest() then
          ...
          for questGroupIdx = 0, tempGroupCount - 1 do
            ...
            if tempQuestInfo._isProgressing and not tempQuestInfo._isCleared and welcomeToTheWorld and not TutorialQuestCompleteCheck() and (3 == tempQuestInfo:getQuestType() or 4 == tempQuestInfo:getQuestType() or 5 == tempQuestInfo:getQuestType() or 6 == tempQuestInfo:getQuestType() or recommandLevel > selfLevel) then
