...
function PaGlobal_ChatMain:poolUpdate(chatPanel, panelIndex)
  ...
  elseif true == chatPanel:isOpen() then
...
function PaGlobal_ChatMain:addTabCheck(currentPanelIndex, openedChattingPanelCount)
  UI.ASSERT_NAME(nil ~= openedChattingPanelCount, "PaGlobal_ChatMain:addTabCheck openedChattingPanelCount\236\157\180 nil\236\157\180\235\169\180 \236\149\136 \235\144\169\235\139\136\235\139\164.", "\236\154\176\236\160\149\235\172\180")
...
function PaGlobal_ChatMain:resetAllScroll()
  ...
  for panelIndex = 0, count - 1 do
    ...
    if chatPanel:isOpen() then
      ...
      if false == ToClient_IsDefineLoadingCharacter() and nil ~= poolCurrentUI._list_Scroll[0] then
