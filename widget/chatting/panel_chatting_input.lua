...
function ChatInput_UpdatePermission()
  ...
  if nil ~= selfPlayerWrapper then
    ...
    if true == selfPlayerWrapper:get():isGuildMember() then
      ...
      if __eGuildMemberGradeMaster == myGrade or __eGuildMemberGradeSubMaster == myGrade or __eGuildMemberGradeAdviser == myGrade then
...
function ChatInput_Show()
  if false == ToClient_IsDefineLoadingCharacter() then
