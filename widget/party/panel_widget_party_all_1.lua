...
function PaGlobal_Party_All:ControlPc_Init()
  ...
  self._ui_pc.radio_onlyLeader_Mini = UI.getChildControl(self._ui_pc.stc_dropSetBg_Mini, "RadioButton_Leader")
...
function PaGlobal_Party_All:registEventHandler()
  ...
  self._ui_pc.radio_onlyLeader_Mini:addInputEvent("Mouse_LUp", "HandleEventLUp_Party_All_SelectLootingType(" .. CppEnums.PartyLootType.LootType_Master .. ")")
  for index = 1, self._config.maxPartyCnt do
...
function PaGlobal_Party_All:setClassMpBar(control, class)
  ...
  if 0 == colorBlindMode then
    ...
    local texturePath = self._textureMPBar.path
    if true == self._ui_pc.stc_optionBG_Mini:GetShow() then
      mpBarTexture = self._textureMPBar_Mini[class]
      texturePath = self._textureMPBar_Mini.path
    end
...
function PaGlobal_Party_All:changeLootingType(lootType)
  ...
  self._ui_pc.radio_onlyLeader_Mini:SetCheck(false)
  ...
  elseif lootType == CppEnums.PartyLootType.LootType_Master then
    ...
    self._ui_pc.radio_onlyLeader_Mini:SetCheck(true)
  end
end
