...
function FGlobal_Introduction_TooltipShow(uiControl, name, desc, isClose, actorKey)
  ...
  if __eClassType_Lhan == playerClass or __eClassType_RangerMan == playerClass or __eClassType_ShyWaman == playerClass or __eClassType_Guardian == playerClass or __eClassType_Hashashin == playerClass or __eClassType_Nova == playerClass or __eClassType_ReservedBlackSpirit == playerClass or __eClassType_Sorcerer_Reserved1 == playerClass then
