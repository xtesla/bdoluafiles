...
function PaGlobal_CharacterSelect_All:setCharacterView(charIdx, classType, isPrimiumCharacter, isChangeSpecialTab)
  ...
  elseif classType == __eClassType_Hashashin then
    ...
    setWeatherTime(8, 16)
  elseif classType == __eClassType_Nova then
    viewCharacter(charIdx, -10, -35, -50, -0.2, isPrimiumCharacter, isChangeSpecialTab)
    viewCharacterPitchRoll(0, 0)
    viewCharacterFov(0.55)
    setWeatherTime(8, 5)
  elseif classType == __eClassType_ReservedBlackSpirit then
    viewCharacter(charIdx, -40, -5, -80, -0.15, isPrimiumCharacter, isChangeSpecialTab)
    viewCharacterPitchRoll(0, 0)
    viewCharacterFov(0.75)
    setWeatherTime(7, 2)
  elseif classType == __eClassType_Sorcerer_Reserved1 then
    viewCharacter(charIdx, -20, -30, -130, -0.1, isPrimiumCharacter, isChangeSpecialTab)
    viewCharacterPitchRoll(0, 0)
    viewCharacterFov(0.75)
    setWeatherTime(6, 3)
  else
