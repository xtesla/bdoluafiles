...
local isAwakenOpen = {
  ...
  [__eClassType_ElfRanger_Reserved1] = ToClient_IsContentsGroupOpen("1477"),
  [__eClassType_ElfRanger_Reserved2] = ToClient_IsContentsGroupOpen("1589")
}
...
Panel_Lobby_ClassUI.ClassButtons[__eClassType_ReservedBlackSpirit] = UI.getChildControl(_frameContents, "RadioButton_Select_Temp1")
...
Panel_Lobby_ClassUI.ClassButtons[__eClassType_ElfRanger_Reserved1] = UI.getChildControl(_frameContents, "RadioButton_Select_Unknown6")
Panel_Lobby_ClassUI.ClassButtons[__eClassType_ElfRanger_Reserved2] = UI.getChildControl(_frameContents, "RadioButton_Select_Unknown7")
...
Panel_Lobby_ClassUI.ClassNames[__eClassType_ReservedBlackSpirit] = UI.getChildControl(_frameContents, "StaticText_Temp1Name")
...
Panel_Lobby_ClassUI.ClassNames[__eClassType_ElfRanger_Reserved1] = UI.getChildControl(_frameContents, "StaticText_Unknown6Name")
Panel_Lobby_ClassUI.ClassNames[__eClassType_ElfRanger_Reserved2] = UI.getChildControl(_frameContents, "StaticText_Unknown7Name")
...
Panel_Lobby_ClassUI.ClassStatus[__eClassType_ReservedBlackSpirit] = UI.getChildControl(Panel_CharacterCreateSelectClass, "Static_Stat_Temp1")
...
Panel_Lobby_ClassUI.ClassStatus[__eClassType_ElfRanger_Reserved1] = UI.getChildControl(Panel_CharacterCreateSelectClass, "Static_Stat_Unknown6")
Panel_Lobby_ClassUI.ClassStatus[__eClassType_ElfRanger_Reserved2] = UI.getChildControl(Panel_CharacterCreateSelectClass, "Static_Stat_Unknown7")
...
local function Panel_Lobby_Function_Initialize()
  ...
  Panel_Lobby_ClassUI.ClassNames[__eClassType_ReservedBlackSpirit]:SetTextMode(__eTextMode_AutoWrap)
  ...
  Panel_Lobby_ClassUI.ClassNames[__eClassType_Nova]:SetTextMode(__eTextMode_AutoWrap)
  ...
  Panel_Lobby_ClassUI.ClassNames[__eClassType_Sorcerer_Reserved1]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_CLASSTYPE_10"))
  ...
  Panel_Lobby_ClassUI.ClassNames[__eClassType_Nova]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_CLASSTYPE_NOVA"))
  Panel_Lobby_ClassUI.ClassNames[__eClassType_Warrior_Reserve2]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_CLASSTYPE_3"))
  Panel_Lobby_ClassUI.ClassNames[__eClassType_ReservedBlackSpirit]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_CLASSTYPE_SAGE"))
  Panel_Lobby_ClassUI.ClassNames[__eClassType_ElfRanger_Reserved1]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_CLASSTYPE_6"))
  Panel_Lobby_ClassUI.ClassNames[__eClassType_ElfRanger_Reserved2]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_CLASSTYPE_7"))
    ...
    if true == _ContentsGroup_UsePadSnapping then
      ...
      if true == isGameTypeKR2() then
        ...
        if nil ~= movieName and "" ~= movieName then
          ...
          if true == isAwakenOpen[index] then
...
function Panel_Lobby_SelectClass_OpenClassHompage()
  if nil == isAwakenOpen[_index] then
    return
  end
  local url = ""
  ...
  if true == isAwakenOpen[_index] and true == Panel_Lobby_UI.CCSC_RadioAwakenMovie:IsCheck() then
    url = url .. "#awakening"
  else
    url = url .. "#original"
  end
...
function Panel_CharacterCreateOK_NewCustomization()
  ...
  local _valid_inputString = PaGlobalFunc_Customization_GetCheckedValidUserInputCharNameString()
  local _valid_isValid = PaGlobalFunc_Customization_GetIsValidUserInputCharNameString()
  if false == _valid_isValid or _edit_CharacterName ~= _valid_inputString then
    local messageBoxData = {
...
function PaGlobalFunc_CharacterSelect_FirstClass()
  if true == ToClient_IsContentsGroupOpen("1589") then
    return __eClassType_Sorcerer_Reserved1
  end
  return nil
end
