...
function CharacterSelectRemaster:changeTexture_Class(control, classType)
  ...
  elseif classType == __eClassType_Nova then
    control:ChangeTextureInfoName("renewal/ui_icon/console_classsymbol.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 229, 286, 285, 342)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
  elseif classType == __eClassType_ReservedBlackSpirit then
    control:ChangeTextureInfoName("renewal/ui_icon/console_classsymbol.dds")
    local x1, y1, x2, y2 = setTextureUV_Func(control, 286, 286, 342, 342)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
  else
    if classType == __eClassType_Sorcerer_Reserved1 then
      control:ChangeTextureInfoName("renewal/ui_icon/console_classsymbol.dds")
      local x1, y1, x2, y2 = setTextureUV_Func(control, 343, 286, 399, 342)
      control:getBaseTexture():setUV(x1, y1, x2, y2)
      control:setRenderTexture(control:getBaseTexture())
    else
    end
