...
function FromClient_FameChanged(actorKeyRaw, beforeFameValue, afterFameValue)
  local variedFameValue = afterFameValue - beforeFameValue
  if 0 == variedFameValue then
    return
  end
  local selfWrapper = getSelfPlayer()
  local selfProxy = selfWrapper:get()
  local selfActorKeyRaw = selfWrapper:getActorKey()
  local selfPosition = float3(selfProxy:getPositionX(), selfProxy:getPositionY(), selfProxy:getPositionZ())
  if selfActorKeyRaw == actorKeyRaw then
    local effectType, effectNumber
    if beforeFameValue >= 0 then
      effectType = 101
      effectNumber = variedFameValue
    else
      effectType = 100
      effectNumber = -1 * variedFameValue
    end
    if 0 == effectNumber then
      UI.ASSERT(false, "Fame\236\157\152 \235\179\128\237\153\148\235\159\137\236\157\180 0 \236\158\133\235\139\136\235\139\164! 0\236\157\128 \236\178\152\235\166\172\237\149\160 \237\149\132\236\154\148\234\176\128 \236\151\134\236\138\181\235\139\136\235\139\164. \236\136\152\236\160\149\236\157\180 \237\149\132\236\154\148\237\149\169\235\139\136\235\139\164.")
    end
    DamageOutputFunction_OnDamage(getSelfPlayer():getActorKey(), effectNumber, effectType, 10, selfPosition, false, getSelfPlayer():getActorKey(), true)
  end
end
...
function DamageOutputFunction_OnDamage(attakeeKeyRaw, effectNumber, effectType, additionalDamageType, posFloat3, isTribeAttack, attackerActorKeyRaw, isNotRandom)
  ...
  elseif 100 == effectType then
    ...
    baseY = baseY + 5
    SetAnimationControl(target.effectList[100], baseX, baseY - 50, timeRate)
  elseif 101 == effectType then
    baseX = baseX - effectControlSetting[101]._sizeX
    baseY = baseY + 5
    SetAnimationControl(target.effectList[101], baseX, baseY - 50, timeRate)
  else
    UI.ASSERT(false, "\236\157\180\236\131\129\237\149\156 \237\154\168\234\179\188\235\178\136\237\152\184\234\176\128 \235\147\164\236\150\180\236\152\180.")
  end
  if isDamageShow then
    ...
    elseif 5 == effectType and true == isGameServiceTypeDev() then
      target.effectList[effectType]:AddEffect("Ui_Damage_Miss", false, 0, 0)
      render_setPointBlur(0.045, 0.05)
      render_setColorBypass(0.8, 0.15)
    end
  end
  if 101 == effectType or 100 == effectType or 96 == effectType or 97 == effectType or 93 == effectType or 92 == effectType or 91 == effectType then
    ...
    baseX = baseX + effectControlSetting[effectType]._sizeX
    SetAnimationControl(arrowControl, baseX, baseY + posOffsetY, timeRate)
  end
end
...
registerEvent("FromClient_FameChanged", "FromClient_FameChanged")
