...
local function PreclosePanel_OpenDialog()
  ...
  elseif nil ~= Panel_ColorBalance and Panel_ColorBalance:GetShow() then
...
function FromClient_hideDialog(isSetWait)
  ...
  if true == _ContentsGroup_NewUI_ReinforceSkill_All then
    Panel_SkillReinforce_All:SetShow(false)
    Panel_Window_ReinforceSkill_All:SetShow(false)
  else
...
function HandleClickedBackButton()
  ...
  if false == _ContentsGroup_NewCloseManager then
    ...
    if true == _ContentsGroup_NewUI_ReinforceSkill_All then
      if Panel_SkillReinforce_All:GetShow() then
        PaGlobalFunc_PaGlobal_SkillReinforce_All_Close()
      end
      if Panel_Window_ReinforceSkill_All:GetShow() then
        PaGlobalFunc_PaGlobal_ReinforceSkill_All_Close()
      end
    else
