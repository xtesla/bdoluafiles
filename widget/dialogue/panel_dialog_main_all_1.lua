...
function PaGlobal_DialogMain_All:prepareClose(isSetWait, isTest, isAttacked, calledByQuestBranch)
  ...
  if true == _ContentsGroup_MiniGame_YachtDice and true == Panel_Window_MiniGame_YachtDice:GetShow() then
  ...
  if true == _ContentsGroup_Production and true == ToClient_isProductionMode() then
...
function PaGlobal_DialogMain_All:registEventHandler()
  ...
  registerEvent("FromClient_DialogFunctionClick_Contents_Wanted", "FromClient_DialogFunctionClick_Contents_Wanted")
