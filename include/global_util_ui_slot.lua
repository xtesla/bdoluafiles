...
function SlotItem:createChild()
  ...
  if nil == self.originalForDuelIcon then
    ...
    self.originalForDuelIcon:ChangeTextureInfoName("Combine/Icon/Combine_Equip_Icon_00.dds")
...
function SlotItem:setItem(itemWrapper, slotNo, equipment, warehouse, familyInven)
  ...
  self:setItemByStaticStatus(itemWrapper:getStaticStatus(), itemWrapper:get():getCount_s64(), expirationIndex, isBroken, isCash, isSoulCollecTor, soulCount, soulMax, isWidget, false, false, familyInven)
...
function SlotItem:setItemByStaticStatus(itemStaticWrapper, s64_stackCount, expirationIndex, isBroken, isCash, isSoulCollecTor, soulCount, soulMax, isWidget, isWorldMarket, isSealed, isFamilyInven)
